...
class _IndexState extends State<Index> {
  late String currentLocation = ''; // Initialize with an empty string
  bool isInPressed = false; // Track the state of the "In" button
                              ...
                              children: [
                                ...
                                SliderButton(
                                  ...
                                  icon: Icon(Icons.chevron_right,
                                      color: Colors.white),
                                  buttonColor: Color.fromARGB(255, 215, 36, 24),
                                ),
                              ],
                            ),
                          ),
